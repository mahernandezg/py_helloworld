...
In mathematics, zero changed civilization.
In computing, zero defines state.
In architecture, zero defines baseline.
...
In distributed systems, complexity is inevitable.
In architecture, entropy increases.
In platforms, governance expands.
